...
class ShirtSelect extends Component {
  ...
  onColorPress(shirtData, colorSelected) {
    this.setState({
      name: shirtData.name,
    ...
    Alert.alert('Add this item to the set?', null, [
      {
        ...
        onPress: () => {
          ...
          this.props.sets.setItemSet('shirt', shirtData);
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={{fontWeight: 'bold'}}>
          Found {this.props.items.shirts.length} items.
        </Text>
...
export default inject('sets', 'items')(observer(ShirtSelect));
